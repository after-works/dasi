...
song.save
songtag = Songtag.new({title:"재미없는 성광이가 추천한 곡들", author:"sxkng"})
songtag.save
...
song.save
songtag = Songtag.new({title:"서른즈음에는 누가 제일 잘 불렀을까?", author:"sxkng"})
songtag.save
...
song.save
songtag = Songtag.new({title:"비와 관련된 노래 중 어떤 노래가 가장 좋을까?", author:"sxkng"})
songtag.save
...
song.save
songtag = Songtag.new({title:"Officially missing you 어느 조합이 짱짱맨?", author:"sxkng"})
songtag.save
...
song.save
songtag = Songtag.new({title:"윤하의 미니앨범 'Just Listen' 에서 가장 좋은 곡은?", author:"sxkng"})
songtag.save
